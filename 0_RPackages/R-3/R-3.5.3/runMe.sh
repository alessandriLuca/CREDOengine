...
docker run -itv $pathSharedfoldHost/R-3.5.3_toBeInstalled:/scratch $1 /scratch/1_libraryInstall.sh # DEVE ESSERE IL PATH DI HOST, DEVE ESSERE LA SHARED FOLDER
...
cp $pathSharedfoldDock/R-3.5.3_toBeInstalled/*.7z* ./$2/R-3.5.3_toBeInstalled/
cp ./pcre2-10.37.tar.gz ./$2/pcre2-10.37.tar.gz
cp -r ./p7zip_16.02 ./$2/
rm -r $pathSharedfoldDock/R-3.5.3_toBeInstalled/packages
rm $pathSharedfoldDock/R-3.5.3_toBeInstalled/1_libraryInstall.sh
rm $pathSharedfoldDock/R-3.5.3_toBeInstalled/dockerFileGenerator.R
rm $pathSharedfoldDock/R-3.5.3_toBeInstalled/libraryInstall.R
rm $pathSharedfoldDock/R-3.5.3_toBeInstalled/*.txt
rm $pathSharedfoldDock/R-3.5.3_toBeInstalled/*.out
cp -r $pathSharedfoldDock/R-3.5.3_toBeInstalled/ ./$2/
