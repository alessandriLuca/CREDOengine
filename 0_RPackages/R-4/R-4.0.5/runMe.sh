...
docker run -tv $pathSharedfoldHost/R-4.0.5_toBeInstalled:/scratch $1 /scratch/1_libraryInstall.sh # DEVE ESSERE IL PATH DI HOST, DEVE ESSERE LA SHARED FOLDER
...
cp -r ./p7zip_16.02 ./$2/
rm -r $pathSharedfoldDock/R-4.0.5_toBeInstalled/packages
rm $pathSharedfoldDock/R-4.0.5_toBeInstalled/1_libraryInstall.sh
rm $pathSharedfoldDock/R-4.0.5_toBeInstalled/dockerFileGenerator.R
rm $pathSharedfoldDock/R-4.0.5_toBeInstalled/libraryInstall.R
rm $pathSharedfoldDock/R-4.0.5_toBeInstalled/*.txt
rm $pathSharedfoldDock/R-4.0.5_toBeInstalled/*.out
