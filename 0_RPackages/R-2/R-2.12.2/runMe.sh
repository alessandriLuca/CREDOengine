...
docker build . -t $1
cp -R ./R-2.12.2_toBeInstalled $pathSharedfoldDock
cp configurationFile.R $pathSharedfoldDock/R-2.12.2_toBeInstalled/libraryInstall.R
docker run -itv $pathSharedfoldHost/R-2.12.2_toBeInstalled:/scratch $1 /scratch/1_libraryInstall.sh # DEVE ESSERE IL PATH DI HOST, DEVE ESSERE LA SHARED FOLDER
...
cp -r ./R-2.12.2 ./$2/
mkdir ./$2/R-2.12.2_toBeInstalled
cp $pathSharedfoldDock/R-2.12.2_toBeInstalled/*.7z* ./$2/R-2.12.2_toBeInstalled/
cp ./pcre2-10.37.tar.gz ./$2/pcre2-10.37.tar.gz
cp -r ./p7zip_16.02 ./$2/
rm -r $pathSharedfoldDock/R-2.12.2_toBeInstalled/packages
rm $pathSharedfoldDock/R-2.12.2_toBeInstalled/1_libraryInstall.sh
rm $pathSharedfoldDock/R-2.12.2_toBeInstalled/dockerFileGenerator.R
rm $pathSharedfoldDock/R-2.12.2_toBeInstalled/libraryInstall.R
rm $pathSharedfoldDock/R-2.12.2_toBeInstalled/*.txt
rm $pathSharedfoldDock/R-2.12.2_toBeInstalled/*.out
cp -r $pathSharedfoldDock/R-2.12.2_toBeInstalled/ ./$2/
