...
docker run -itv $pathSharedfoldHost/$1_jupyter_notebook/PtoBeInstalled:/scratch $2 /scratch/1_libraryInstall.sh
...
docker build $pathSharedfoldDock/$1_jupyter_notebook -t $2
docker run -itv $pathSharedfoldHost/$1_jupyter_notebook/RtoBeInstalled:/scratch $2 /scratch/1_libraryInstall.sh
